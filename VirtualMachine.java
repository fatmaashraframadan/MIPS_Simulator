...
public class VirtualMachine {
	...
	public void sw(String machincode) {
		...
		int index =r1+offist/4;
		if (index >= memory_address) {
			index = index - memory_address;// md const value get the first address in memory=100000
		}
		// System.out.println(r1+" "+r2+" "+len);
		memory.memorydata[index] = r2;
	}
	...
	public void and(String machincode) { // not finished yet
		...
		if (r2 >= memory_address) {// md const value get the first address in memory=100000
